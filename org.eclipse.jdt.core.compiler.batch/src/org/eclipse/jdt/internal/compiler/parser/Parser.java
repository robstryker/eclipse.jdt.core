...
protected void consumeRule(int act) {
  switch ( act ) {
    ...
    case 253 : if (DEBUG) { System.out.println("UnnamedVariable ::= Underscore"); }  //$NON-NLS-1$
 ...
 consumeMethodDeclaration(false, false);
    ...
    case 510 : if (DEBUG) { System.out.println("Resource ::= Type PushModifiers UnnamedVariable..."); }  //$NON-NLS-1$
...
protected void consumeUnnamedVariable() {
	// TODO: report error if this is used in < Java or preview features are disabled
	if (this.parsingJava21Plus && this.previewEnabled) {
		return;
	}
}
